            ...
            <main className="crt">
                <div className="wrapper blinking">
                    <pre style={{ backgroundColor: 'transparent', color: 'inherit', border: 'none' }}>
                        ...
                        <span style={{ paddingLeft: "8em" }}>{"<"}</span><span className="green">route</span> <span className="lightblue">path</span>=<a href="/digital-card/#/"><span className="coral">"/"</span></a> <span className="lightblue">element</span>=<span className="blue">{"{"}</span>{"<"}<span className="green">{"Init"}</span>{"/>"}<span className="blue">{"}"}</span> /&gt;<br />
                        <span style={{ paddingLeft: "8em" }}>{"<"}</span><span className="green">route</span> <span className="lightblue">path</span>=<a href="/digital-card/#/home.jsx"><span className="coral">"/home"</span></a> <span className="lightblue">element</span>=<span className="blue">{"{"}</span>{"<"}<span className="green">{"Home"}</span>{"/>"}<span className="blue">{"}"}</span> /&gt;<br />
